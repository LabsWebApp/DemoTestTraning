...
public class CaptchaCommonViewModel : NotifyDataErrorInfoViewModel
{
    ...
    public string? CaptchaCode
    {
        ...
        set
        {
            ...
            {
                var hashedCode = _model.Code;
                if (hashedCode != null && !VerifyHashedString(_captchaCode, hashedCode, true))
                {
